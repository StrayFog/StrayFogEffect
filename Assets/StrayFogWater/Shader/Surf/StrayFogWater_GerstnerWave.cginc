...
half3 GerstnerOffset4(half2 xzVtx, half4 steepness, half4 amp, half4 freq, half4 speed, half4 dirAB, half4 dirCD, half4 gerstnerVertexIntensity) {
	...
	offsets.xyz *= gerstnerVertexIntensity;

	return offsets;
}

half3 GerstnerNormal4(half2 xzVtx, half4 steepness, half4 amp, half4 freq, half4 speed, half4 dirAB, half4 dirCD,half4 gerstnerVertexIntensity) {
	...
	nrml.xz *= gerstnerVertexIntensity;
	nrml = normalize(nrml);
...
half3 CalcGerstnerWaveNormal(half3 P, half4 steepness, half4 amplitude, half4 frequency, half4 speed, half4 directionAB, half4 directionCD,half4 gerstnerVertexIntensity)
{
	...
	normal.xz *= gerstnerVertexIntensity;
...
void GerstnerOffsetOnly(out half3 offs,
	...
	half4 speed, half4 directionAB, half4 directionCD,half4 gerstnerVertexIntensity) {
	offs = GerstnerOffset4(tileableVtx.xz, steepness, amplitude, frequency, speed, directionAB, directionCD, gerstnerVertexIntensity);
}
...
void Gerstner(out half3 offs, out half3 nrml,
	...
	half4 speed, half4 directionAB, half4 directionCD,half4 gerstnerVertexIntensity) {
	offs = GerstnerOffset4(tileableVtx.xz, steepness, amplitude, frequency, speed, directionAB, directionCD, gerstnerVertexIntensity);
	nrml = GerstnerNormal4(tileableVtx.xz + offs.xz, steepness, amplitude, frequency, speed, directionAB, directionCD, gerstnerVertexIntensity);
	...
	//vtx = (vtx + offs);
	//nrml = CalcGerstnerWaveNormal(vtx, steepness, amplitude, frequency, speed, directionAB, directionCD,gerstnerVertexIntensity);                                 
}
